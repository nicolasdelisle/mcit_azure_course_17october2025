resource "azurerm_storage_account" "storage_$var.name" {
...
resource "azurerm_storage_container" "storagecontainermay" {
  ...
  storage_account_id    = azurerm_storage_account.azurestoagemcit.id
  container_access_type = var.container_access_type
}

resource "azurerm_storage_blob" "storageblobmay" {
  name                   = var.storageblobmay
  storage_account_name   = azurerm_storage_account.azurestoagemcit.name
